...
class Person extends ImpostorBase {
  ...
  firstName(sex) {
    if (!Object.prototype.hasOwnProperty.call(namesData['firstNames'], sex)) {
      sex = this.randomArrayElement(['male', 'female']);
    }

    return this.randomArrayElement(namesData['firstNames'][sex]);
  }
